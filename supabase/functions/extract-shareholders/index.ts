...
function matchBranch(input: string): string | null {
  ...
  const aliases: Record<string, string> = {
    ...
    "آل عبدالرحمن عبدالرزاق وأبناؤه": "آل عبدالرحمن",
    "آل عبدالرحمن عبدالرزاق": "آل عبدالرحمن",
    "عبدالرزاق وأبناؤه": "عبدالرازق وأبناؤه",
    "عبدالرازق وابناؤه": "عبدالرازق وأبناؤه",
    "عبدالرزاق": "عبدالرازق وأبناؤه",
    "عبدالرازق": "عبدالرازق وأبناؤه",
    "أبناء سليم بن عبدالله": "عبدالرازق وأبناؤه",
  };
...
- family_branch: طابق اسم الفرع تماماً مع القائمة. "الشرايره"="الشرايرة"، "عتيق وابناؤه"="عتيق وأبناؤه"، "أبناء سعد بن سليم"="أبناء سعد سليم"، "آل عبدالرحمن عبدالرزاق وأبناؤه"="آل عبدالرحمن"، "عبدالرازق وابناؤه" أو "عبدالرزاق وأبناؤه"="عبدالرازق وأبناؤه".
- ملاحظة: "آل عبدالرحمن" و "عبدالرازق وأبناؤه" فرعان مستقلان منفصلان تماماً، لا تدمجهما.
