...
export function CommitteeArchive({ committeeId, committeeName }: Props) {
  ...
  return (
    <div className="rounded-2xl border bg-card shadow-soft overflow-hidden">
      <div className="px-6 py-4 border-b bg-gradient-to-l from-primary/5 to-transparent flex items-center gap-2">
        <Archive className="h-5 w-5 text-primary" />
        <div className="flex-1">
          <h3 className="font-bold text-sm">أرشيف اللجنة</h3>
          <p className="text-[11px] text-muted-foreground">
            ارفع التقارير والصور والملفات السابقة لتظهر في صفحة التقارير وتُسكَّن من الإدارة العليا حسب العام
          </p>
        </div>
        <Badge variant="outline" className="text-[10px]">{items.length} ملف</Badge>
      </div>
