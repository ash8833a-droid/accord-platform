...
function FinancePage() {
  ...
  return (
    <div className="space-y-7">
      <div>
        <h1 className="text-3xl font-bold">اللجنة المالية</h1>
        <p className="text-muted-foreground mt-1">إدارة المحفظة، المناديب، الاشتراكات، وطلبات الصرف الواردة من اللجان</p>
      </div>
      ...
      <Tabs defaultValue="requests" dir="rtl">
        <TabsList className="grid grid-cols-3 w-full max-w-2xl">
          ...
          <TabsTrigger value="delegates" className="gap-2">
            <Users2 className="h-4 w-4" /> المناديب
          </TabsTrigger>
          <TabsTrigger value="subs" className="gap-2">
            <CheckCircle2 className="h-4 w-4" /> الاشتراكات
          </TabsTrigger>
        </TabsList>
